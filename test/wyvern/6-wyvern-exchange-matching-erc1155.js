...
contract("WyvernExchange", (accounts) => {
    ...
    it("matches erc1155 nft-nft swap order", async () => {
        ...
        await Promise.all([
            erc1155.mint(account_a, nfts[0].tokenId),
            erc1155.mint(account_b, nfts[1].tokenId),
        ]);
    ...
    it("matches erc1155 + erc20 <> erc1155 orders, matched left, real static call", async () => {
        ...
        const firstERC1155Call =
            erc1155c.methods
                .safeTransferFrom(account_a, account_b, tokenId, 1, "0x")
                .encodeABI() + ZERO_BYTES32.substr(2);
    ...
    const erc1155_erc20_match_right_static_call = async (
        ...
        await Promise.all([
            ...
            erc1155.mint(account_b, tokenId, maximumFill),
        ]);
