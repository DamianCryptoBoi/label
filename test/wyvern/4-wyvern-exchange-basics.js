...
contract('WyvernExchange',accounts => {
  const withExchangeAndRegistry = async () => {
    ...
    let exchange = await WyvernExchange.new(CHAIN_ID,[registry.address],'0x')
  ...
  it('correctly hashes order to sign',async () => {
    ...
    assert.equal(hashToSign(example,exchange.address),hash,'Incorrect order hash')
  })

  it('does not allow set-fill to same fill',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    let example = {registry: registry.address, maker: accounts[1], staticTarget: exchange.address, staticSelector: '0x00000000', staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '6'}
  ...
  it('validates valid order parameters',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    let example = {registry: registry.address,maker: accounts[0],staticTarget: exchange.address,staticSelector: '0x00000000',staticExtradata: '0x',maximumFill: '1',listingTime: '0',expirationTime: '1000000000000',salt: '0'}
  ...
  it('does not validate order parameters with listingTime after now',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    let example = {registry: registry.address,maker: accounts[0],staticTarget: exchange.address,staticSelector: '0x00000000', staticExtradata: '0x', maximumFill: '1', listingTime: '1000000000000', expirationTime: '1000000000000', salt: '0'}
    assert.isFalse(await exchange.validateOrderParameters(example),'Should not have validated')
  })

  it('does not validate order parameters with expirationTime before now',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    let example = {registry: registry.address,maker: accounts[0],staticTarget: exchange.address,staticSelector: '0x00000000',staticExtradata: '0x',maximumFill: '1',listingTime: '0',expirationTime: '1',salt: '0'}
    assert.isFalse(await exchange.validateOrderParameters(example),'Should not have validated')
  })

  it('validates valid authorization by signature (sign_typed_data)',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    let example = {registry: registry.address,maker: accounts[1],staticTarget: exchange.address,staticSelector: '0x00000000',staticExtradata: '0x',maximumFill: '1',listingTime: '0',expirationTime: '1000000000000',salt: '100230'}
  ...
  it('validates valid authorization by signature (personal_sign)',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    let example = {registry: registry.address,maker: accounts[1],staticTarget: exchange.address,staticSelector: '0x00000000',staticExtradata: '0x',maximumFill: '1',listingTime: '0',expirationTime: '1000000000000',salt: '100231'}
    let hash = hashOrder(example)
  ...
  it('does not validate authorization by signature with different prefix (personal_sign)',async () => {
    ...
    let example = {registry: registry.address,maker: accounts[1],staticTarget: wrappedexchange.address,staticSelector: '0x00000000',staticExtradata: '0x',maximumFill: '1',listingTime: '0',expirationTime: '1000000000000',salt: '100231'}
    let hash = hashOrder(example)
  ...
  it('does not allow approval twice',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    let example = {registry: registry.address,maker: accounts[1],staticTarget: exchange.address,staticSelector: '0x00000000',staticExtradata: '0x',maximumFill: '1',listingTime: '0',expirationTime: '1000000000000',salt: '1010'}
  ...
  it('does not allow approval from another user',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    const example = {registry: registry.address, maker: accounts[1], staticTarget: exchange.address, staticSelector: '0x00000000', staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '10101234'}
    return assertIsRejected(
  ...
  it('validates valid authorization by approval',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    const example = {registry: registry.address, maker: accounts[1], staticTarget: exchange.address, staticSelector: '0x00000000', staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '10'}
    await exchange.approveOrder(example,false,{from: accounts[1]})
  ...
  it('validates valid authorization by hash-approval',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    const example = {registry: registry.address, maker: accounts[1], staticTarget: exchange.address, staticSelector: '0x00000000', staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '1'}
    const hash = hashOrder(example)
  ...
  it('validates valid authorization by maker',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    const example = {registry: registry.address, maker: accounts[0], staticTarget: exchange.address, staticSelector: '0x00000000', staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '5'}
    const hash = hashOrder(example)
  ...
  it('validates valid authorization by cache',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    const example = {registry: registry.address, maker: accounts[1], staticTarget: exchange.address, staticSelector: '0x00000000', staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '6'}
  ...
  it('does not validate authorization without signature',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    const example = {registry: registry.address, maker: accounts[1], staticTarget: exchange.address, staticSelector: '0x00000000', staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '0'}
    const hash = hashOrder(example)
  ...
  it('does not validate cancelled order',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    const example = {registry: registry.address, maker: accounts[0], staticTarget: exchange.address, staticSelector: '0x00000000', staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '20'}
  ...
  it('allows order cancellation by maker',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    const example = {registry: registry.address, maker: accounts[0], staticTarget: exchange.address, staticSelector: '0x00000000', staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '3'}
    assert.isOk(await exchange.setOrderFill(example, 1))
  })

  it('allows order cancellation by non-maker',async () => {
    let {exchange,registry} = await withExchangeAndRegistry()
    const example = {registry: registry.address, maker: accounts[1], staticTarget: exchange.address, staticSelector: '0x00000000', staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '4'}
    assert.isOk(await exchange.setOrderFill(example, 1))
  })
})
